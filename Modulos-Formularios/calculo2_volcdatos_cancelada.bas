Attribute VB_Name = "calculo2_volcdatos_cancelada"
Option Explicit

Sub calculo_2_volcado_datos_cancelada()
 ...
 End If
  ...
  For e = año_hipoteca To año_actual - 1
   ...
   uf = Worksheets("cuadro_amortizacion").Range("A" & Rows.Count).End(xlUp).Row
    ...
    buscarv_irph = Application.VLookup(e, tabla_irph, mes_revision + 1, False)
    interes_irph_con_diferencial = buscarv_irph + diferencial
    buscarv_euribor = Application.VLookup(e, tabla_euribor, mes_revision + 1, False)
